...
The system SHALL calculate the stop-loss price as buy_price × (1 - stop_loss_value / 100) when method is "percentage".
...
The system SHALL calculate the stop-loss price as highest_price × (1 - stop_loss_value / 100) when method is "trailing". The trailing stop-loss price SHALL never decrease.
