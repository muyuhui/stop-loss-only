...
from routers import ai, alerts, dashboard, holdings, monitoring, operations, positions, prices, risk, runtime, settings
...
def create_app() -> FastAPI:
    ...
    for router in (holdings.router, positions.router, prices.router, alerts.router, dashboard.router, settings.router, monitoring.router, operations.router, risk.router, runtime.router, ai.router):
